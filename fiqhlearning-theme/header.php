    ...
    <header id="masthead" class="site-header">
                    ...
                    <div class="top-bar-right">
                        <?php if (get_theme_mod('fiqh_telegram_link')) : ?>
                            <a href="<?php echo esc_url(get_theme_mod('fiqh_telegram_link')); ?>" target="_blank" class="top-link">
                                ...
                                <?php echo esc_html(get_theme_mod('header_telegram_text', __('قناة التليجرام', 'fiqhlearning'))); ?>
                            </a>
                        <?php endif; ?>
                        <?php if (get_theme_mod('fiqh_whatsapp_link')) : ?>
                            <a href="<?php echo esc_url(get_theme_mod('fiqh_whatsapp_link')); ?>" target="_blank" class="top-link">
                                ...
                                <?php echo esc_html(get_theme_mod('header_whatsapp_text', __('واتساب', 'fiqhlearning'))); ?>
                            </a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="header-content">
                    ...
                    <nav id="site-navigation" class="main-navigation">
                        <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
                            ...
                            <span class="screen-reader-text"><?php echo esc_html(get_theme_mod('header_menu_text', __('القائمة', 'fiqhlearning'))); ?></span>
                        </button>
                    ...
                    <div class="header-actions">
                        <!-- زر البحث -->
                        <button class="search-toggle" aria-label="<?php echo esc_attr(get_theme_mod('header_search_label', __('بحث', 'fiqhlearning'))); ?>">
                        ...
                        <!-- زر الوضع الليلي -->
                        <button class="dark-mode-toggle" aria-label="<?php echo esc_attr(get_theme_mod('header_dark_mode_label', __('تبديل الوضع الليلي', 'fiqhlearning'))); ?>">
                        ...
                        <?php if (is_user_logged_in()) : ?>
                            ...
                            <div class="user-menu-wrapper">
                                <button class="user-menu-toggle" aria-label="<?php echo esc_attr(get_theme_mod('header_my_account_label', __('حسابي', 'fiqhlearning'))); ?>">
                                ...
                                <div class="user-dropdown">
                                    ...
                                    <a href="<?php echo esc_url(get_edit_profile_url()); ?>" class="dropdown-item">
                                        ...
                                        <?php echo esc_html(get_theme_mod('header_profile_text', __('الملف الشخصي', 'fiqhlearning'))); ?>
                                    </a>
                                    <a href="<?php echo esc_url(wp_logout_url(home_url())); ?>" class="dropdown-item">
                                        ...
                                        <?php echo esc_html(get_theme_mod('header_logout_text', __('تسجيل الخروج', 'fiqhlearning'))); ?>
                                    </a>
                                </div>
                            </div>
                        <?php else : ?>
        ...
        <div class="search-modal" style="display: none;">
            <div class="search-modal-content">
                <button class="search-modal-close" aria-label="<?php echo esc_attr(get_theme_mod('header_close_label', __('إغلاق', 'fiqhlearning'))); ?>">
                ...
                <form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
                    <input type="search" class="search-field" placeholder="<?php echo esc_attr(get_theme_mod('header_search_placeholder', __('ابحث عن مقررات، دروس، مقالات...', 'fiqhlearning'))); ?>" value="<?php echo get_search_query(); ?>" name="s" />
                    <button type="submit" class="search-submit">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="11" cy="11" r="8"></circle>
                            <path d="m21 21-4.35-4.35"></path>
                        </svg>
                        <span class="screen-reader-text"><?php echo esc_html(get_theme_mod('header_search_label', __('بحث', 'fiqhlearning'))); ?></span>
                    </button>
                </form>
            </div>
        </div>
